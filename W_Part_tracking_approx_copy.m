...
Xplot=1./param_wyb(do_plot==1);
scatter(log(Xplot),log(Yplot),6,[zeros(size(Stwyb(do_plot==1))); Stwyb(do_plot==1)/max(Stwyb(do_plot==1)); 1- Stwyb(do_plot==1)/max(Stwyb(do_plot==1)) ]','filled') %16*Awyb(do_plot==1)/max(Awyb(do_plot==1))
set(gca,'FontSize',fsize,'YScale','log')
xlabel('A/St','interpreter','latex')
