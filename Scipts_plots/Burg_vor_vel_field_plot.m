...
yyaxis left
plot(r_bez,-vr_bez,r_bez,vfi_bez)
ylabel('$u^{\ast}$','interpreter','latex')
yyaxis right
plot(z_bez,vz_bez)
ylabel('u_z^{\ast}')
xlabel('r/\delta')
set(gca,'FontSize',fsize)
text(12,0.032,char('A=', num2str(A)),'FontSize',fsize+4)
text(4,0.018,'$-u_{\varphi}$','FontSize',fsize+4,'interpreter','latex','Color',[0,0.45, 0.74])
text(4.3,0.0028,'$u_r$','FontSize',fsize+4,'interpreter','latex','Color',[0,0.45, 0.74])
