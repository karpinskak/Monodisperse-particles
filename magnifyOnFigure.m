...
toolId =    double(appDataStruct.figureHandle)+...
            double(appDataStruct.mainAxesHandle)+...
            double(appDataStruct.magnifierHandle)+...
            double(appDataStruct.linkHandle)+...
           double(appDataStruct.secondaryAxesHandle);
